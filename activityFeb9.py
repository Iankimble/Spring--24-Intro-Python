...
#2. - Write a block of code where a user can enter three(3) numbers, multiply
# those numbers together and then output the result using the int() function. 

#3. - Write a block of code where a user enters a their name, age, and shoe size, 
